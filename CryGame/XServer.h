...
public:
	...
	BannedID(const unsigned char *vByteArr, unsigned char bArrSize, const string &szPlayerName) { memset(vBanID, 0, 64); memcpy(vBanID, vByteArr, min(bArrSize, (unsigned char)64)); szName = szPlayerName; bSize = bArrSize; };
